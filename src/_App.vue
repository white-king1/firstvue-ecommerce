            ...
            <div class="slider-wrapper-area4 mt-18 mt-md-0 mt-sm-0">
              <div class="hero-slider-active hero__4 slick-dot-style hero-dot">
                <div
                  ...
                  style="
                    background-image: url(assets/img/slider/slider4_bg1.jpg);
                  "
                >
                  <div class="container">
                ...
                <div class="category-toggle-wrap max-100">
                  ...
                  <nav class="category-menu static hm-1">
                    <ul>
                        ...
                        <ul class="category-mega-menu">
                          <li class="menu-item-has-children">
                            ...
                            <ul>
                              ...
                              <li>
                                <a href="shop-grid-left-sidebar.html">Uawei</a>
                              </li>
                              <li>
                                <a href="shop-grid-left-sidebar.html"
                                  >Cherry Berry</a
                        ...
                        <ul class="category-mega-menu">
                          <li class="menu-item-has-children">
                            ...
                            <ul>
                              ...
                              <li>
                                <a href="shop-grid-left-sidebar.html">uPhone</a>
                              </li>
                            </ul>
                          </li>
                          <li class="menu-item-has-children">
                      ...
                      <li>
                        <a href="shop-grid-left-sidebar.html"
                          ><i class="fa fa-clock-o"></i> watch</a
                        >
                      </li>
                      <li>
                        <a href="shop-grid-left-sidebar.html"
            ...
            <div class="tab-content">
                      ...
                      <div class="col">
                        <div class="product-item fix mb-30">
                          <div class="product-thumb">
                            <a href="product-details.html">
                              <img
                                src="@/assets/img/product/product-s-1.jpg"
                                class="img-pri"
                                alt=""
                              />
                              <img
                                src="@/assets/img/product/product-s-2.jpg"
                                class="img-sec"
                                alt=""
                              />
                            </a>
                      ...
                      <div class="col">
                        <div class="product-item fix mb-30">
                          <div class="product-thumb">
                            <a href="product-details.html">
                              <img
                                src="@/assets/img/product/product-s-3.jpg"
                                class="img-pri"
                                alt=""
                              />
                              <img
                                src="@/assets/img/product/product-s-4.jpg"
                                class="img-sec"
                                alt=""
                              />
                            </a>
                      ...
                      <div class="col">
                        <div class="product-item fix mb-30">
                          <div class="product-thumb">
                            <a href="product-details.html">
                              <img
                                src="@/assets/img/product/product-s-5.jpg"
                                class="img-pri"
                                alt=""
                              />
                              <img
                                src="@/assets/img/product/product-s-6.jpg"
                                class="img-sec"
                                alt=""
                              />
                            </a>
                          ...
                          <div class="product-content">
                            <h4>
                              <a href="product-details.html">vertual product</a>
                            </h4>
                            <div class="pricebox">
                      ...
                      <div class="col">
                        <div class="product-item fix mb-30">
                          <div class="product-thumb">
                            <a href="product-details.html">
                              <img
                                src="@/assets/img/product/product-f-1.jpg"
                                class="img-pri"
                                alt=""
                              />
                              <img
                                src="@/assets/img/product/product-f-2.jpg"
                                class="img-sec"
                                alt=""
                              />
                            </a>
                      ...
                      <div class="col">
                        <div class="product-item fix mb-30">
                          <div class="product-thumb">
                            <a href="product-details.html">
                              <img
                                src="@/assets/img/product/product-f-3.jpg"
                                class="img-pri"
                                alt=""
                              />
                              <img
                                src="@/assets/img/product/product-f-4.jpg"
                                class="img-sec"
                                alt=""
                              />
                            </a>
                      ...
                      <div class="col">
                        <div class="product-item fix mb-30">
                          <div class="product-thumb">
                            <a href="product-details.html">
                              <img
                                src="@/assets/img/product/product-b-1.jpg"
                                class="img-pri"
                                alt=""
                              />
                              <img
                                src="@/assets/img/product/product-b-2.jpg"
                                class="img-sec"
                                alt=""
                              />
                            </a>
                      ...
                      <div class="col">
                        <div class="product-item fix mb-30">
                          <div class="product-thumb">
                            <a href="product-details.html">
                              <img
                                src="@/assets/img/product/product-b-3.jpg"
                                class="img-pri"
                                alt=""
                              />
                              <img
                                src="@/assets/img/product/product-b-4.jpg"
                                class="img-sec"
                                alt=""
                              />
                            </a>
              ...
              <div class="tab-pane fade" id="tab_two">
                <div class="feature-category-carousel-wrapper">
                  <div class="container">
                    <div
                      class="featured-carousel-active2 row slick-arrow-style"
                      data-row="2"
                    >
                      <!-- product single item start -->
                      <div class="col">
                ...
                <div class="blog-item">
                  ...
                  <div class="blog-content">
                    ...
                    <p>
                      ...
                      Curabitur sed diam enim. Sed varius faucibus lectus varius
                      faucibus ac...
                    </p>
                  </div>
                  <a href="blog-details.html"
